...
<head>
<title></title>
<link href="${basePath }/mf/css/default.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
    ...
    window.onload = function() {
        ...
        var settings = {
            ...
            upload_url: "${basePath }file/fileUpload",
    ...
    function uploadSuccess(file, serverData) {
    	...
    	if (serverData.code == 200) {
    		...
    		//document.getElementById("imageUrl").src = path + serverData.fileUrl;
    		
    		//是否回调
    		var callbackMethodName = "${callbackMethodName }";
    		var result = "{\"name\": \""+file.name+"\", \"fileUrl\": \""+serverData.fileUrl+"\", \"smallImgSrc\": \""+serverData.smallImgSrc+"\", \"middleImgSrc\": \""+serverData.middleImgSrc+"\", \"bigImgSrc\": \""+serverData.bigImgSrc+"\"}"; 
