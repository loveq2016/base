...
<html>
  ...
  <![endif]-->
		...
		<link href="plug-in/login/css/buttons.css" rel="stylesheet"
			type="text/css" />
		<link href="plug-in/login/css/icon.css" rel="stylesheet"
			type="text/css" />
	...
	<body>
		...
		<div id="login">
			...
			<div class="inner">
				...
				<div class="formLogin">
					<form name="formLogin" id="formLogin" action="loginCheck"
						method="post">
						...
						<div class="loginButton">
							<div style="float: left; margin-left: -9px;">
								<input type="checkbox" id="on_off" name="remember"
									checked="ture" class="on_off_checkbox" value="0" />
							...
							<div style="float: right; padding: 3px 0; margin-right: -12px;">
								...
								<div style="float: left; margin-left: 30px;">
									<a href="loginController.do?goPwdInit"><span class="f_help">是否初始化admin的密码</span>
									</a>
								</div>
							</div>
							<div class="clear"></div>
		...
		<div id="versionBar">
			<div class="copyright">
				&copy; 版权所有
				<span class="tip"><a href="#" title="JEECG 新版演示系统">jeecg</a>
					(推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#"
					title="JEECG 新版演示系统">jeecg</a>
				</span>
			</div>
		</div>
		<!-- Link JScript-->
		...
		<script type="text/javascript"
			src="plug-in/login/js/jquery-jrumble.js"></script>
