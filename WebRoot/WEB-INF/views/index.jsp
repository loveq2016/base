...
<html>
  ...
  <body class="easyui-layout" style="overflow-y: hidden" scroll="no">
		<!-- 顶部-->
		<div region="north" border="false" title="管理系统"
						...
						<table>
							<tr>
								<td valign="top" height="50">
									...
									<span style="color: #666633"><a href="logout">退出</a></span>
								</td>
							</tr>
						</table>
					</td>
									...
									<c:if test="${item.id eq childItem.parentId}">
										<li>
											<div onclick="addTab('${childItem.name}','${childItem.linkUrl}','pictures')"
												title="${childItem.name}" url="userController.do?user"
												iconCls="pictures">
												<a class="${childItem.name}" href="#"> <span
													class="icon pictures">&nbsp;</span> <span class="nav">${childItem.name}</span>
												</a>
											</div>
										</li>
									</c:if>
