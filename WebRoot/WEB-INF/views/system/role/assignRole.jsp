...
<div class="easyui-layout" style="width: 100%; height: 100%;">
	<div data-options="region:'east',split:true" title="已经存在的角色" style="width: 220px;height: 100%;">
		...
		<table class="easyui-datagrid" style="height:465px;" userId="${param.userId }" id="existGrid" data-options="rownumbers:true,singleSelect:true,collapsible:true,url:'system/role/findByUserId?userId=${param.userId }',method:'get',pageSize:20">
			<thead>
				<tr>
