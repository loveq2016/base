	...
	<div id="tbUser" style="padding: 5px; height: auto">
		<div style="margin-bottom: 5px">
			<sec:authorize access="hasRole('USER_ADD')">
				<a href="javascript:void(0);" onclick="add('system/user/showView?action=1001','添加用户',400,420);" class="easyui-linkbutton" iconCls="icon-add" plain="true" title="添加">添加</a>
			</sec:authorize>
			<sec:authorize access="hasRole('USER_UPDATE')">
				<a href="javascript:void(0);" onclick="update('system/user/showView?action=1002','修改用户',400,420);" class="easyui-linkbutton" iconCls="icon-edit" plain="true" title="编辑">编辑</a>
			</sec:authorize>
		...
		<div id="${namespace }SearchDiv">
			...
			</select> <a href="javascript:void(0);" onclick="searchData();" class="easyui-linkbutton" iconCls="icon-search">搜索</a>
		</div>
	</div>
